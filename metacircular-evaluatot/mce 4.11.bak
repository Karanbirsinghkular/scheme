...
;FOR ALL EXERCISES BEFORE 4.10 THE FOLLOWING CODE IS TO BE COPY-PASTED
;/////////////////////////////////////////////////////////////////////
;/////////////////////////////////////////////////////////////////////
;THE APPLICATION? PREDICATE IS DEFINED INCORRECTLY,FIX IN ALL CODES.
...
(define (make-frame variables values)
  (map cons variables values));CONS IS USED CUZ FRAMEVALUES RETURNS CDR OF LIST AND NOT CADR
...
(define (set-variable-value! var val env)
  (define (env-loop env)
    (define (scan vars vals frame)
      (cond ((null? vars)
             (env-loop (enclosing-environment env)))
            ((eq? var (car vars)) (set-car! (cons vals val) frame))
            (else (scan (cdr vars) (cdr vals) (cdr frame)))))
    (if (eq? env the-empty-environment)
